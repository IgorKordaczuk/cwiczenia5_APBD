...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnDept30EmpsOrderedBySalaryDesc()
    {
        ...
        List<Emp> result = emps.Where(emp => emp.DeptNo == 30)
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        var chicagoDepts = depts.Where(dept => dept.Loc == "CHICAGO")
    ...
    public void ShouldCalculateAverageSalaryPerDept()
    {
        ...
        var result = emps
            ...
            {
                DeptNo = res.Key,
                AvgSal = res.Average(emp => emp.Sal)
            })
            .ToList();
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var deptAvgDict = emps
            .GroupBy(e => e.DeptNo)
            .ToDictionary(g => g.Key, g => g.Average(e => e.Sal));

        var result = emps
            .Where(emp => emp.Sal > deptAvgDict[emp.DeptNo])
